...
<table>
  ...
  <tr>
      <td>URGENCY_TIER</td>
      <td>{High: 3, Medium: 2, Low: 1}</td>
      <td>Set at ticket creation</td>
  </tr>
  <tr>
      <td>URGENCY_WEIGHT</td>
      <td>0.6</td>
      <td>Urgency matters most (60%)</td>
  </tr>
  <tr>
      <td>TIME_ELAPSED</td>
      <td>Hours since created_at</td>
      <td>Current time - created_at</td>
  </tr>
  <tr>
      <td>AGE_WEIGHT</td>
      <td>0.4</td>
      <td>Age matters second (40%)</td>
  </tr>
  <tr>
      <td>TIME_FACTOR</td>
      <td>log(TIME_ELAPSED + 1)</td>
      <td>Logarithmic; prevents very old items from dominating</td>
  </tr>
</table>
